...
6. 본문을 다 읽지 않아도 핵심만 파악할 수 있도록, 글에서 가장 중요한 사실 2~4개를
   ...
   말고 간결하게 다시 쓰세요).
7. 제목을 정하기 전에 위 [이미 발행된 글 목록]의 제목들을 훑어보고, 그 제목들과
   형식이 겹치지 않는 쪽을 고르세요. 특히 최근 글이 "~까요?/~라고요?"로 끝나는
   질문형이었다면 이번엔 다른 형식(아래 TONE_GUIDE의 제목 형식 목록 참고)을
   쓰세요 — 같은 형식이 연달아 나오지 않게 할 것.
