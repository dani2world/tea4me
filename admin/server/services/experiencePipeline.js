...
2. 메모와 사진 내용을 바탕으로 블로그 글 전체를 작성하세요. 담담하고 차분한 1인칭 에세이 톤,
   과장된 감탄사나 광고 문구 없이. 문단은 3~5개, 각 문단은 빈 줄로 구분. 문장 종결은
   "~습니다"체보다 "~다/~였다/~인 듯했다" 같은 일기체(평서형)를 기본으로 쓰세요 —
   개인적인 기록이라는 느낌이 더 자연스럽게 삽니다.
...
"이 문장, AI가 쓴 것처럼 매끈하고 뻔하지 않은가?"를 스스로 점검하고 고치세요.
